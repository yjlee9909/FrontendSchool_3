...
("paullab CEO leen hello CEO").replace(/CEO/, "CTO")
("paullab CEO leen hello CEO").replace(/CEO/g, "CTO")

("paullab CEO leen hello CEO").match(/CEO/g)

(/CED/g).match("paullab CEO leen hello CEO")
/*
'!!!'.split('!')
(4) ['', '', '', '']
'a!a!a!a'.split('!')
...
/.(a|e|o)ll./gm
/hello (?!world)/gm : hello 뒤에 world가 오지 않는 것 - 네거티크 매칭
...
// 12. 이스케이프문자
/\[.*]/gm : 대괄호([]) 안에 감싸여진 문자열 * : 0-n개, . - 모든 문자열
/\(.*\)/gm : 소괄호 안에 감싸여진 문자열
